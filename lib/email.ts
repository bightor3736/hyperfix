...
export async function sendWeeklyDigestEmail({
  ...
  const streakLine = streak > 0
    ? `<li>${streak}-day check-in streak — keep it going</li>`
    : "";
  const topFixLine = topFix
    ? `<li>longest fix: <em>&ldquo;${topFix.title}&rdquo;</em> at ${topFix.days} days</li>`
    : "";
  const graveyardLine = graveyardCount > 0
    ? `<li>${graveyardCount} fix${graveyardCount !== 1 ? "es" : ""} in your graveyard</li>`
    : "";
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#080808;padding:40px 16px;">
  <tr><td align="center">
    <table width="500" cellpadding="0" cellspacing="0" style="max-width:500px;width:100%;">
      ...
      <tr><td style="padding-bottom:12px;">
        <ul style="margin:0;padding-left:20px;font-size:15px;line-height:2;color:rgba(244,244,244,0.55);">
