import { BookOpen, ShieldCheck, Dice5, BrickWall, Flame, Clock, Check, Zap, Snowflake, Timer } from "lucide-react";
import { Reveal } from "./Reveal";

/**
 * Tiimo-style content modules: alternating warm pastel blocks, each pairing a
 * big serif headline + supporting copy with a clean little product mockup.
 */
      ...
      >
        ...
        >
          <div className="max-w-[460px]">
            <p className="font-mono text-[11px] uppercase tracking-widest mb-4 text-ink-muted">
              {eyebrow}
            </p>
  ...
  return (
    <section id="how" style={{ background: "var(--bg)" }}>
      <div className="mx-auto max-w-[1100px] px-6 sm:px-10 py-20 sm:py-28">
        <Reveal>
          <div className="max-w-[640px] mb-12">
            ...
            <h2 className="font-display leading-[1.05] tracking-tight text-ink" style={{ fontSize: "clamp(32px,5vw,52px)" }}>
              Four tools. One brain that finally feels seen.
            </h2>
          </div>
        </Reveal>
        ...
        {/* Forgiving streaks — full-width banner */}
        <Reveal>
          <div className="mt-5 overflow-hidden rounded-[var(--radius-xl)] p-8 sm:p-12" style={{ background: "var(--pastel-orange)" }}>
