...
function Sparkline({ intensity }: { intensity: number }) {
  ...
  return (
    <svg width="100%" height={h} viewBox={`0 0 ${w} ${h}`} preserveAspectRatio="none">
      ...
      <path d={d} fill="none" stroke="#A3E635" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
    ...
    >
      ...
      <div style={{ marginTop: 10, display: "flex", alignItems: "flex-end", gap: 6 }}>
        ...
        <div style={{ paddingBottom: 10, display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          <span style={{
            background: intensity >= 8 ? "#E63946" : intensity >= 6 ? "#FB923C" : "#A3E635",
            color: "#0A0A0A",
            borderRadius: 999,
            padding: "2px 8px",
            fontSize: 10,
      ...
      <div style={{ marginTop: 12 }}>
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
          ...
          <span style={{ color: "#A3E635", fontSize: 10, fontWeight: 700 }}>
            {intensity}/10
          </span>
        </div>
        <div style={{
