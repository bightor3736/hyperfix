...
const S = {"--bg":"#FAF6F0","--bg-soft":"#F3EDE4","--bg-elevated":"#FFFFFF","--ink":"#2B2440","--ink-muted":"#564E70","--ink-faint":"#8B84A3","--line":"#E9E2D8","--line-strong":"#D9D1C5","--accent":"#FF5A36","--accent-soft":"rgba(255,90,54,0.12)","--accent-ink":"#FFFFFF","--energy":"#FF5A36","--energy-soft":"rgba(255,90,54,0.12)","--xp":"#6D5AE6","--xp-soft":"rgba(109,90,230,0.12)","--flame":"#F2541B","--flame-soft":"#FEE9E5","--primary":"#FF5A36","--primary-foreground":"#FFFFFF","--card":"#FFFFFF","--card-foreground":"#2B2440","--muted-foreground":"#564E70","--border":"#E9E2D8","--invert-bg":"#2B2440","--invert-ink":"#FAF6F0","--reward-mint":"#3ECF9B","--reward-mint-soft":"#E0F8EF",background:"var(--bg)",fontFamily:"var(--font-grotesk),system-ui,sans-serif",color:"#2B2440"} as React.CSSProperties;
