  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: "#0A0A0A" }}>
        <div className="animate-pulse rounded-full h-6 w-6" style={{ background: "rgba(163,230,53,0.3)" }} />
      </div>
    );
  }
  ...
  if (notFound) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4" style={{ background: "#0A0A0A" }}>
        ...
        <Link href="/dashboard/lists" className="font-mono text-sm underline" style={{ color: "#A3E635" }}>← Back to lists</Link>
      </div>
    );
  }
        ...
        <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            <input
              ...
              maxLength={80}
              className="w-full rounded-xl px-4 py-3 font-sans text-sm outline-none focus:ring-2 focus:ring-[#A3E635]/40 transition-all"
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              maxLength={300}
              className="w-full rounded-xl px-4 py-3 font-sans text-sm outline-none focus:ring-2 focus:ring-[#A3E635]/40 resize-none transition-all"
              style={{ background: "#111113", border: "1px solid rgba(244,244,244,0.1)", color: "#F4F4F4" }}
            />
          </div>
