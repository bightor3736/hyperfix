...
const SHIRTS: Record<string, ShirtSet> = {
  ...
  purple: { base: "#8A60D4", light: "#AA80F4", dark: "#6A40B4" },
  grey:   { base: "#8A9098", light: "#AAB0B8", dark: "#6A7078" },
};
...
function Guy({
  ...
  return (
    <svg width={size} height={h} viewBox="0 0 500 950" fill="none">
      ...
      />
      {/* Brim top */}
      <path d="M 158 132 Q 250 150 342 132 L 342 144 Q 250 160 158 144Z" fill="#D0CEC8" />
      {/* Brim underside */}
      <path d="M 160 140 Q 250 156 340 140 Q 340 152 250 156 Q 160 152 160 140Z" fill="rgba(0,0,0,0.22)" />
      {/* Cap shadow on face */}
      <path d="M 172 136 Q 250 158 328 136 Q 328 168 250 170 Q 172 168 172 136Z" fill="rgba(0,0,0,0.12)" />
      {/* Seam */}
      ...
      {mood === "confident" ? (
        ...
        <>
          <ellipse cx={mood === "excited" ? 216 : 217} cy="174" rx="10" ry="10" fill="#1A0A00" />
          <circle  cx={mood === "excited" ? 219 : 220} cy="170" r="3.5" fill="white" />
          <ellipse cx={mood === "excited" ? 288 : 289} cy="174" rx="10" ry="10" fill="#1A0A00" />
...
function Slide({
  ...
  return (
    ...
    >
      ...
      <div style={{
        position: "absolute",
        bottom: -360, left: "50%", transform: "translateX(-50%)",
      ...
      <div style={{
        position: "absolute",
        bottom: 280, left: "50%", transform: "translateX(-50%)",
        width: 700, height: 400, borderRadius: "50%",
        background: "radial-gradient(ellipse at 50% 80%, rgba(60,120,50,0.28) 0%, transparent 70%)",
        filter: "blur(30px)",
      }} />
      ...
      <div style={{ position: "absolute", top: 82, left: 72, right: 72, textAlign: "center" }}>
        <p style={{
          fontFamily: "var(--font-sans)", fontSize: 80, fontWeight: 700,
          color: "#FFFFFF", lineHeight: 1.14, margin: 0,
      ...
      <div style={{ position: "absolute", bottom: 72, left: 72, right: 72, textAlign: "center" }}>
        <p style={{
          fontFamily: "var(--font-sans)", fontSize: 80, fontWeight: 700,
          color: "#FFFFFF", lineHeight: 1.14, margin: 0,
          textShadow: "0 2px 20px rgba(0,0,0,0.4)",
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: "radial-gradient(ellipse at 50% 75%, rgba(94,234,212,0.18) 0%, transparent 68%)",
        filter: "blur(40px)",
      }} />

      <div style={{
        position: "absolute",
        bottom: 480, left: "50%", transform: "translateX(-50%)",
        lineHeight: 0,
      }}>
        <Guy shirt="cream" mood="happy" size={540} />
      </div>
      ...
      <div style={{ position: "absolute", top: 82, left: 72, right: 72, textAlign: "center" }}>
        <p style={{
          ...
          Your brain is not lazy. It's not broken.
        </p>
      </div>

      <div style={{ position: "absolute", bottom: 80, left: 72, right: 72, textAlign: "center" }}>
        <p style={{
          fontFamily: "var(--font-sans)", fontSize: 76, fontWeight: 700,
          color: "#FFFFFF", lineHeight: 1.14, margin: "0 0 52px",
          textShadow: "0 2px 24px rgba(0,0,0,0.5)",
        }}>
        ...
        <div style={{
          ...
          <span style={{
            fontFamily: "var(--font-sans)", fontSize: 58, fontWeight: 700,
            color: "#081A10", letterSpacing: "-0.01em",
          }}>
            hyperfix.app
          </span>
        </div>
        <p style={{
          ...
          color: "rgba(255,255,255,0.35)", margin: 0, letterSpacing: "0.04em",
        }}>
...
export default function AdhdStruggles() {
  return (
    <div
    ...
    >
      {/* 1 — HOOK */}
      <Slide
        top="ADHD comes with superpowers. But it also comes with battles most people never see."
        bottom="Here are 5 of them."
        shirt="cream"
        mood="knowing"
      />
      ...
      {/* 2 — Task initiation */}
      <Slide
        top="While everyone else just opens their laptop and starts,"
        bottom="Your ADHD brain needs 3 hours, 4 fake starts, and a deadline to begin a 10-minute task."
        shirt="yellow"
        mood="determined"
      />
      ...
      {/* 3 — Time blindness */}
      <Slide
        top="Neurotypical people can feel time passing."
        bottom="Your ADHD brain only knows two times: right now, and not yet real."
        shirt="blue"
        mood="knowing"
      />
      ...
      {/* 4 — RSD */}
      <Slide
        top="When someone gives you mild criticism,"
        bottom="Your ADHD brain processes it as full-scale rejection and replays it for 6 hours."
        shirt="purple"
        mood="determined"
      />
      ...
      {/* 5 — Paralysis */}
      <Slide
        top="You know exactly what needs to be done."
        bottom="Your ADHD brain simply will not let your body start doing it."
        shirt="coral"
        mood="determined"
      />
      ...
      {/* 6 — Emotional volume */}
      <Slide
        top="Neurotypical people feel something and move on."
        bottom="Your ADHD brain parks it at full volume in the front row for the rest of the day."
        shirt="red"
        mood="excited"
      />
