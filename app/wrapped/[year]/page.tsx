    ...
    return (
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 60% 40% at 50% -10%, rgba(163,230,53,0.12) 0%, transparent 70%)",
          }}
        />
        <span className="font-mono text-[11px] uppercase tracking-widest" style={{ color: "#A3E635" }}>
    ...
    return (
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 60% 40% at 50% -10%, rgba(163,230,53,0.08) 0%, transparent 70%)",
          }}
        />
        <span className="font-mono text-[11px] uppercase tracking-widest" style={{ color: "#A3E635" }}>
          hyperfix wrapped {year}
