          ...
          <section className="relative px-6 sm:px-10 pt-16 sm:pt-20 pb-6 overflow-hidden">
            ...
            >
              <span
                ...
                style={{
                  ...
                  color: "transparent",
                  WebkitTextStroke: "1.5px rgba(163,230,53,0.13)",
                  lineHeight: 0.85,
                }}
              >
                Pricing
            ...
            <div className="absolute top-20 right-8 sm:right-12 pointer-events-none" aria-hidden="true">
              <span
                ...
                style={{ fontSize: "clamp(1.6rem, 4vw, 3rem)", color: "rgba(163,230,53,0.7)" }}
              >
                Hyperfix
              </span>
            </div>
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-4">
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: "inset 0 1px 0 rgba(163,230,53,0.08), 0 0 40px rgba(163,230,53,0.05)",
                }}
              >
                {/* inner corner glow */}
                <div
