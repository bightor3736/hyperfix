...
function CoverSlide({ total }: { total: number }) {
  return (
    <div style={{ width: W, height: H, background: INK, display: "flex", flexDirection: "column", padding: "120px 96px", position: "relative", overflow: "hidden" }}>
      <div style={{ position: "absolute", top: -300, right: -300, width: 1000, height: 1000, background: "radial-gradient(circle, rgba(163,230,53,0.15) 0%, transparent 65%)", borderRadius: "50%", display: "flex" }} />
...
function SignSlide({ slide, index, total }: { slide: Extract<SignsSlide, { type: "sign" }>; index: number; total: number }) {
  return (
    <div style={{ width: W, height: H, background: INK, display: "flex", flexDirection: "column", padding: "120px 96px", position: "relative", overflow: "hidden" }}>
      <div style={{ position: "absolute", bottom: -200, left: -200, width: 800, height: 800, background: "radial-gradient(circle, rgba(163,230,53,0.1) 0%, transparent 65%)", borderRadius: "50%", display: "flex" }} />
...
function OutroSlide() {
  return (
    <div style={{ width: W, height: H, background: INK, display: "flex", flexDirection: "column", padding: "120px 96px", position: "relative", overflow: "hidden" }}>
      <div style={{ position: "absolute", top: "50%", left: "50%", width: 1200, height: 1200, background: "radial-gradient(circle, rgba(163,230,53,0.12) 0%, transparent 60%)", borderRadius: "50%", display: "flex" }} />
      <span style={{ fontSize: 32, fontWeight: 900, color: LIME, letterSpacing: "-0.03em", display: "flex", marginBottom: "auto" }}>hyperfix</span>
...
function PovCoverSlide({ total }: { total: number }) {
  return (
    <div style={{ width: W, height: H, background: INK, display: "flex", flexDirection: "column", padding: "120px 96px", position: "relative", overflow: "hidden" }}>
      <div style={{ position: "absolute", top: -200, right: -200, width: 900, height: 900, background: "radial-gradient(circle, rgba(163,230,53,0.18) 0%, transparent 65%)", borderRadius: "50%", display: "flex" }} />
      <div style={{ position: "absolute", bottom: -300, left: -200, width: 700, height: 700, background: "radial-gradient(circle, rgba(163,230,53,0.08) 0%, transparent 65%)", borderRadius: "50%", display: "flex" }} />
      <span style={{ fontSize: 32, fontWeight: 900, color: LIME, letterSpacing: "-0.03em", display: "flex", marginBottom: "auto" }}>hyperfix</span>
...
function PovDaySlide({ slide, index, total }: { slide: Extract<PovSlide, { type: "pov-day" }>; index: number; total: number }) {
  return (
    <div style={{ width: W, height: H, background: INK, display: "flex", flexDirection: "column", padding: "120px 96px", position: "relative", overflow: "hidden" }}>
      <div style={{ position: "absolute", bottom: -180, right: -180, width: 700, height: 700, background: "radial-gradient(circle, rgba(163,230,53,0.1) 0%, transparent 65%)", borderRadius: "50%", display: "flex" }} />
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "auto" }}>
        <span style={{ fontSize: 32, fontWeight: 900, color: LIME, letterSpacing: "-0.03em", display: "flex" }}>hyperfix</span>
        <span style={{ fontSize: 26, color: DIM, letterSpacing: "0.04em", display: "flex" }}>{index + 1} of {total}</span>
      </div>
...
function PovOutroSlide() {
  return (
    <div style={{ width: W, height: H, background: INK, display: "flex", flexDirection: "column", padding: "120px 96px", position: "relative", overflow: "hidden" }}>
      <div style={{ position: "absolute", top: "40%", left: "50%", width: 1100, height: 1100, background: "radial-gradient(circle, rgba(163,230,53,0.13) 0%, transparent 60%)", borderRadius: "50%", display: "flex" }} />
      <span style={{ fontSize: 32, fontWeight: 900, color: LIME, letterSpacing: "-0.03em", display: "flex", marginBottom: "auto" }}>hyperfix</span>
...
const gradSlides = [
  {
    bg: "#070B14",
    glow1: { color: "rgba(163,230,53,0.22)", x: "80%", y: "-10%" },
  ...
  {
    bg: "#050F05",
    glow1: { color: "rgba(163,230,53,0.2)", x: "50%", y: "40%" },
