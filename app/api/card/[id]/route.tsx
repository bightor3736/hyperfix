              ...
              {intensityBlocks.map((active, i) => (
                <div
                  ...
                  style={{
                    ...
                    height: 28,
                    borderRadius: 4,
                    background: active ? "#A855F7" : "rgba(244,244,244,0.08)",
                  }}
                />
              ))}
              <span
        ...
        >
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(circle, rgba(168,85,247,0.22) 0%, rgba(168,85,247,0.06) 50%, transparent 70%)",
              top: "50%",
              left: "50%",
          ...
          >
            ...
            >
              hyper
              <span style={{ color: "#A855F7", fontStyle: "italic" }}>fix</span>
            </div>
            <div
              style={{
                fontFamily: "ui-monospace, monospace",
