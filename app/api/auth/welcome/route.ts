        ...
        <table width="500" cellpadding="0" cellspacing="0" style="max-width:500px;width:100%;">
          ...
          <tr>
            <td style="padding-bottom:40px;">
              <span style="font-size:22px;font-weight:800;letter-spacing:-0.03em;color:#A855F7;">
                hyperfix
              </span>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding-bottom:48px;">
              <a
                ...
                style="display:inline-block;background:#A855F7;color:#0A0A0A;font-size:14px;font-weight:700;text-decoration:none;padding:14px 28px;border-radius:12px;letter-spacing:0.01em;"
              >
                start logging &rarr;
              </a>
            </td>
