    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", marginBottom: 32 }}>
          <span style={{ color: "#A3E635", fontWeight: 800, fontSize: 28, letterSpacing: "-0.02em" }}>hyper</span>
        ...
        <div style={{ display: "flex", gap: 32, flex: 1 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16, width: 380 }}>
            ...
            >
              ...
              <span style={{ color: "#A3E635", fontSize: 14, fontWeight: 600 }}>
                {longestDays} days
              </span>
            </div>
            ...
            >
              <span style={{ color: "rgba(163,230,53,0.6)", fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase" }}>
                hyperfix says
              </span>
...
function StatBox({ value, label, small = false }: { value: string; label: string; small?: boolean }) {
  return (
    ...
    >
      <span style={{ color: "#A3E635", fontSize: small ? 26 : 40, fontWeight: 800, lineHeight: 1, letterSpacing: "-0.02em" }}>
        {value}
      </span>
